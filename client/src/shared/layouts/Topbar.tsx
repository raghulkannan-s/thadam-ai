    ...
    <header className="sticky top-0 z-30 flex h-16 w-full items-center justify-between border-b border-[var(--border-subtle)] bg-[var(--bg-surface)]/80 px-8 backdrop-blur-md">
      ...
      <div className="flex items-center space-x-4">
        ...
        <button 
          ...
          className={`relative rounded-full p-2 text-[var(--text-secondary)] transition-all duration-300 hover:bg-[var(--bg-elevated)] ${ringing ? 'animate-shake scale-110 text-yellow-500 bg-yellow-500/20 shadow-lg shadow-yellow-500/50' : ''}`}

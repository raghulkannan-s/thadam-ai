  ...
  return (
    <div className="flex min-h-screen items-center justify-center p-6">
      <div className="panel w-full max-w-md rounded-2xl p-8 sm:p-10 animate-scale-in">
        <div className="mb-2">
          <div className="badge badge-accent mb-4">Welcome back</div>
        </div>
        ...
        <p className="mt-7 text-center text-sm" style={{ color: "var(--text-secondary)" }}>
          New here?{" "}
          <Link href={`/register?redirect=${encodeURIComponent(getRedirectTarget())}`} className="font-semibold no-underline" style={{ color: "var(--accent-secondary)" }}>
            Create an account
          </Link>
        </p>
      </div>

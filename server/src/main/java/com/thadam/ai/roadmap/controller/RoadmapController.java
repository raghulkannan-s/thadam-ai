package com.thadam.ai.roadmap.controller;
...
import com.thadam.ai.roadmap.dto.RoadmapGenerationRequest;
...
import com.thadam.ai.roadmap.service.RoadmapGenerationService;
import com.thadam.ai.roadmap.service.RoadmapService;
...
public class RoadmapController {
    ...
    @GetMapping("/public")
    public ResponseEntity<ApiResponse<Page<CommunityRoadmapResponse>>> getCommunityRoadmaps(
            @PageableDefault(sort = "createdAt", direction = Sort.Direction.DESC) Pageable pageable,
            @AuthenticationPrincipal User user) {
        Page<CommunityRoadmapResponse> roadmaps = roadmapService.getCommunityRoadmaps(pageable, user);
        return ResponseEntity.ok(ApiResponse.success(roadmaps));
    }
}
